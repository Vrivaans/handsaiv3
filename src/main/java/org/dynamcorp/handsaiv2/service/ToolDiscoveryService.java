        ...
        return List.of(
                new ToolDefinition(
                        ...
                        java.util.Map.of(
                                ...
                                "properties", java.util.Map.of(
                                        "agent_id",
                                        java.util.Map.of("type", "string", "description",
                                        ...
                                        "confidence",
                                        java.util.Map.of("type", "number", "description",
                                ...
                                "required", List.of("agent_id", "intent", "confidence"))),
                new ToolDefinition(
                        "handsai_get_intent",
                ...
                new ToolDefinition(
                        ...
                        java.util.Map.of(
                                ...
                                "properties", java.util.Map.of(
                                        "title",
                                        java.util.Map.of("type", "string", "description", "Título descriptivo corto"),
                                        "category",
                                        java.util.Map.of("type", "string", "description",
                                ...
                                "required", List.of("title", "category", "content_what"))),
                new ToolDefinition(
